...
export const T = {
  fr: {
    ...
    jeu_telephones_titre: "Jeu des téléphones", jeu_telephones_intro: "Associez chaque service à son numéro interne (PAX, SISCO ou Stento). Choisissez un mode pour commencer.",
  ...
  nl: {
    ...
    jeu_telephones_titre: "Telefoonspel", jeu_telephones_intro: "Koppel elke dienst aan zijn interne nummer (PAX, SISCO of Stento). Kies een modus om te beginnen.",
