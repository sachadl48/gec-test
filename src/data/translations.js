...
export const T = {
  fr: {
    ...
    jeu_telephones_titre: "Jeu des téléphones", jeu_telephones_intro: "Associez chaque service à son numéro interne (PAX, CISCO ou Stento). Choisissez un mode pour commencer.",
    mode_normale_titre: "Mode normal", mode_normale_desc: "Numéros et services mélangés, sans chronomètre.",
    mode_normale_desc_stations: "Numéros et noms de stations mélangés, sans chronomètre.",
    mode_chrono_hard_desc_stations: "{n} secondes, avec des choix très proches du bon numéro.",
    jeu_abreviations_titre: "Jeu des abréviations", jeu_abreviations_intro: "Devinez la signification d'un acronyme STIB parmi 4 choix. Choisissez un mode pour commencer.",
    jeu_traductions_titre: "Jeu des traductions", jeu_traductions_intro: "Associez un terme STIB à sa traduction, dans les deux sens. Choisissez un mode pour commencer.",
    mode_normale_desc_abrev: "Acronymes mélangés, sans chronomètre.", mode_normale_desc_traductions: "Termes mélangés, sans chronomètre.",
    question_abreviation: "Que signifie cet acronyme ?", question_fr_to_nl: "Quelle est la traduction en néerlandais ?", question_nl_to_fr: "Quelle est la traduction en français ?",
    voir_glossaire_btn: "Voir le glossaire complet",
    jeu_donnees_vides_titre: "Aucune donnée pour ce jeu", jeu_donnees_vides_body: "La liste est vide pour le moment — ajoute des entrées depuis \"Gestion des jeux\".",
    mode_chrono_hard_titre: "Mode chrono Hard", mode_chrono_hard_desc: "{n} secondes, uniquement les numéros à trouver, avec des choix très proches du bon.",
    question_num_to_service_court: "Quel service correspond à ce numéro ?", question_service_to_num_court: "Quel est le numéro de ce service ?",
    numero_word: "Numéro", masquer_liste_btn: "Masquer la liste", voir_liste_stations_btn: "Voir la liste des stations", voir_liste_telephones_btn: "Voir la liste des services",
    ...
    difficulte_facile: "Facile", difficulte_hard: "Hard", difficulte_chrono_uniquement: "S'applique uniquement au mode chronométré",
    nouveau_record_badge: "Nouveau record !",
    score_non_enregistre: "Ce score n'a pas pu être enregistré (problème de connexion). Réessaie, ou préviens un admin si ça persiste.",
    ...
    rejouer_btn: "Rejouer", jouer_btn: "Jouer",
    ...
    feedback_duty_label: "Feedback Duty", feedback_duty_titre: "Feedback Duty — Jours {debut} à {fin}",
    feedback_par_label: "Par", feedback_redaction_par: "Rédigé par {nom}", feedback_placeholder: "Feedback de l'admin sur cette semaine...",
    carpass_onglet_titre: "CarPass SYREM",
    carpass_intro: "Feedback général de l'instructeur au centre de formation SYREM, pour situer où en était l'élève à son arrivée. Modifiable uniquement par les Gunmen et les Admin +.",
    carpass_commentaires_titre: "Commentaires fin de formation", carpass_cotations_titre: "Cotations",
    carpass_col_chapitre: "Chapitre", carpass_col_cotation: "Cotation", carpass_col_commentaire: "Commentaire spécifique",
    carpass_semaine_1: "Semaine 1", carpass_semaine_2: "Semaine 2", carpass_semaine_3: "Semaine 3",
    ...
    sous_onglet_cotations: "Cotations", sous_onglet_matieres: "Matière/Manœuvres/Actions",
    matiere_faite_label: "Fait", matiere_pas_faite_label: "Pas fait",
    matiere_fois_count: "{n} fois", matiere_jamais_faite: "Jamais faite pour le moment.",
    ...
    note_lue_badge: "Lue", note_pas_lue_badge: "Pas lue",
    ...
    formation_debut_label: "Début de formation :", formation_fin_label: "Fin de formation :",
    formation_sans_date_tooltip: "Pas de date de formation", formation_plus_4_mois: "+4 mois",
    ...
    nav_enquetes: "Enquêtes de satisfaction",
    nav_gestion_moniteurs: "Gestion des Moniteurs",
    nav_gestion_jeux: "Gestion des jeux",
    ajouter_btn: "Ajouter", ajouter_entree_titre: "Ajouter une entrée", modifier_entree_titre: "Modifier l'entrée",
    rechercher_placeholder: "Rechercher...",
    col_numero: "Numéro", col_nom_fr: "Nom FR", col_nom_nl: "Nom NL",
    col_service_fr: "Service FR", col_service_nl: "Service NL",
    col_acronyme: "Acronyme", col_signification: "Signification",
    col_terme_fr: "Terme FR", col_terme_nl: "Terme NL",
    supprimer_entree_titre: "Supprimer cette entrée",
    confirm_supprimer_entree_msg: "Supprimer définitivement cette entrée ? Cette action est irréversible.",
    sous_onglet_enquete_satisfaction: "Enquête de satisfaction", sous_onglet_performances_moniteurs: "Performances des moniteurs",
    performances_generale_titre: "Performances générale", performances_par_moniteur_titre: "Par moniteur",
    performances_aucune_donnee_titre: "Aucune donnée pour l'instant", performances_aucune_donnee_body: "Le graphique s'alimentera dès qu'une enquête sera complétée.",
    performances_aucun_moniteur_titre: "Aucun profil moniteur enregistré.",
    supprimer_enquete_titre: "Supprimer cette enquête",
    confirm_supprimer_enquete_msg: "Supprimer définitivement l'enquête de {nom} ? Ses cotations seront retirées des graphiques de performances.",
    enquete_satisfaction_titre: "Enquête de satisfaction",
    enquete_aucune_pour_instant: "Aucune enquête pour le moment ...",
    enquete_a_remplir: "À remplir",
    enquete_intro: "Votre avis sur la formation reçue — pas anonyme, vos réponses sont liées à votre profil.",
    enquete_partie_formation: "La formation", enquete_partie_moniteurs: "Les moniteurs",
    enquete_aucun_moniteur: "Aucun moniteur enregistré sur ce carnet.",
    commentaire_facultatif_placeholder: "Commentaire (facultatif)...",
    commentaire_placeholder: "Votre réponse...",
    enquete_notes_manquantes: "Une note est encore manquante pour pouvoir soumettre l'enquête.",
    enquete_soumettre_btn: "Soumettre l'enquête", enquete_envoi_en_cours: "Envoi en cours...",
    enquetes_terminees_titre: "Enquête(s) terminée(s)", enquetes_en_attente_titre: "Enquête(s) en attente(s)",
    aucune_enquete_titre: "Aucune enquête pour le moment.",
    enquete_de_prefix: "Enquête de satisfaction de", enquete_completee_le: "Complétée le",
    eleve_inconnu: "Élève inconnu", erreur_inconnue: "Erreur inconnue.",
    ...
    titre_admin_label: "Titre", titre_admin_standard: "Admin (standard)",
    ...
    reseau_ajouter_station: "Ajouter une station", reseau_tracer_trait: "Tracer un trait", reseau_numero_station_placeholder: "N° station",
    reseau_nom_station_placeholder: "Nom de la station",
    ...
    legende_correction_aide: "La comparaison est automatique (orthographe stricte) — utilisez ✓/✗ pour corriger si besoin (accent oublié, réponse jugée correcte malgré tout...). Les points s'ajustent automatiquement.",
    ...
    question_verrouillee_titre: "Question déjà en cours de modification",
    question_verrouillee_msg: "{nom} est déjà en train de modifier cette question. Réessayez dans quelques minutes.",
    quelquun_dautre: "quelqu'un d'autre",
    ...
    voir_description_categorie: "Voir/modifier la description", description_categorie_placeholder: "Description (optionnelle)...",
    description_categorie_titre: "Description — {cat}", aucune_description: "Aucune description pour cette catégorie.",
    ...
    mode_questions_ciblees: "Question(s) ciblée(s)", rechercher_question_placeholder: "Rechercher par numéro ou texte...",
    aucune_question_trouvee: "Aucune question ne correspond.", questions_selectionnees_n: "{n} question(s) sélectionnée(s)",
    ...
    point_word: "Point", ajoutez_image_dabord: "Ajoutez d'abord une image ci-dessus.", retirer_image_btn: "Retirer l'image",
  ...
  nl: {
    ...
    jeu_telephones_titre: "Telefoonspel", jeu_telephones_intro: "Koppel elke dienst aan zijn interne nummer (PAX, CISCO of Stento). Kies een modus om te beginnen.",
    mode_normale_titre: "Normale modus", mode_normale_desc: "Nummers en diensten door elkaar, zonder tijdslimiet.",
    mode_normale_desc_stations: "Nummers en stationsnamen door elkaar, zonder tijdslimiet.",
    mode_chrono_hard_desc_stations: "{n} seconden, met keuzes die heel dicht bij het juiste nummer liggen.",
    jeu_abreviations_titre: "Afkortingenspel", jeu_abreviations_intro: "Raad de betekenis van een STIB-afkorting uit 4 keuzes. Kies een modus om te beginnen.",
    jeu_traductions_titre: "Vertaalspel", jeu_traductions_intro: "Koppel een STIB-term aan zijn vertaling, in beide richtingen. Kies een modus om te beginnen.",
    mode_normale_desc_abrev: "Afkortingen door elkaar, zonder tijdslimiet.", mode_normale_desc_traductions: "Termen door elkaar, zonder tijdslimiet.",
    question_abreviation: "Wat betekent deze afkorting?", question_fr_to_nl: "Wat is de vertaling in het Nederlands?", question_nl_to_fr: "Wat is de vertaling in het Frans?",
    voir_glossaire_btn: "Volledige woordenlijst bekijken",
    jeu_donnees_vides_titre: "Geen gegevens voor dit spel", jeu_donnees_vides_body: "De lijst is momenteel leeg — voeg items toe via \"Beheer van spellen\".",
    mode_chrono_hard_titre: "Chrono Hard-modus", mode_chrono_hard_desc: "{n} seconden, enkel de nummers zoeken, met keuzes die heel dicht bij het juiste liggen.",
    question_num_to_service_court: "Welke dienst hoort bij dit nummer?", question_service_to_num_court: "Wat is het nummer van deze dienst?",
    numero_word: "Nummer", masquer_liste_btn: "Lijst verbergen", voir_liste_stations_btn: "Lijst van stations bekijken", voir_liste_telephones_btn: "Lijst van diensten bekijken",
    ...
    difficulte_facile: "Makkelijk", difficulte_hard: "Hard", difficulte_chrono_uniquement: "Enkel van toepassing op de tijdgebonden modus",
    nouveau_record_badge: "Nieuw record!",
    score_non_enregistre: "Deze score kon niet worden opgeslagen (verbindingsprobleem). Probeer opnieuw, of verwittig een admin als het aanhoudt.",
    ...
    rejouer_btn: "Opnieuw spelen", jouer_btn: "Spelen",
    reset_btn: "Resetten",
    ...
    feedback_duty_label: "Feedback Duty", feedback_duty_titre: "Feedback Duty — Dag {debut} tot {fin}",
    feedback_par_label: "Door", feedback_redaction_par: "Opgesteld door {nom}", feedback_placeholder: "Feedback van de admin over deze week...",
    carpass_onglet_titre: "CarPass SYREM",
    carpass_intro: "Algemene feedback van de instructeur bij het opleidingscentrum SYREM, om te weten waar de leerling stond bij aankomst. Enkel bewerkbaar door Gunmen en Admin +.",
    carpass_commentaires_titre: "Opmerkingen einde opleiding", carpass_cotations_titre: "Beoordelingen",
    carpass_col_chapitre: "Hoofdstuk", carpass_col_cotation: "Beoordeling", carpass_col_commentaire: "Specifieke opmerking",
    carpass_semaine_1: "Week 1", carpass_semaine_2: "Week 2", carpass_semaine_3: "Week 3",
    ...
    sous_onglet_cotations: "Scores", sous_onglet_matieres: "Leerstof/Manoeuvres/Acties",
    matiere_faite_label: "Gedaan", matiere_pas_faite_label: "Niet gedaan",
    matiere_fois_count: "{n} keer", matiere_jamais_faite: "Nog nooit gedaan.",
    ...
    note_lue_badge: "Gelezen", note_pas_lue_badge: "Niet gelezen",
    ...
    formation_debut_label: "Start opleiding:", formation_fin_label: "Einde opleiding:",
    formation_sans_date_tooltip: "Geen opleidingsdatum", formation_plus_4_mois: "+4 maanden",
    ...
    nav_enquetes: "Tevredenheidsenquêtes",
    nav_gestion_moniteurs: "Beheer van Instructeurs",
    nav_gestion_jeux: "Beheer van spellen",
    ajouter_btn: "Toevoegen", ajouter_entree_titre: "Item toevoegen", modifier_entree_titre: "Item bewerken",
    rechercher_placeholder: "Zoeken...",
    col_numero: "Nummer", col_nom_fr: "Naam FR", col_nom_nl: "Naam NL",
    col_service_fr: "Dienst FR", col_service_nl: "Dienst NL",
    col_acronyme: "Afkorting", col_signification: "Betekenis",
    col_terme_fr: "Term FR", col_terme_nl: "Term NL",
    supprimer_entree_titre: "Dit item verwijderen",
    confirm_supprimer_entree_msg: "Dit item definitief verwijderen? Deze actie kan niet ongedaan worden gemaakt.",
    sous_onglet_enquete_satisfaction: "Tevredenheidsenquête", sous_onglet_performances_moniteurs: "Prestaties van instructeurs",
    performances_generale_titre: "Algemene prestaties", performances_par_moniteur_titre: "Per instructeur",
    performances_aucune_donnee_titre: "Nog geen gegevens", performances_aucune_donnee_body: "De grafiek wordt gevuld zodra een enquête is voltooid.",
    performances_aucun_moniteur_titre: "Geen instructeursprofiel geregistreerd.",
    supprimer_enquete_titre: "Deze enquête verwijderen",
    confirm_supprimer_enquete_msg: "De enquête van {nom} definitief verwijderen? De scores worden verwijderd uit de prestatiegrafieken.",
    enquete_satisfaction_titre: "Tevredenheidsenquête",
    enquete_aucune_pour_instant: "Momenteel geen enquête ...",
    enquete_a_remplir: "In te vullen",
    enquete_intro: "Uw mening over de gevolgde opleiding — niet anoniem, uw antwoorden zijn gekoppeld aan uw profiel.",
    enquete_partie_formation: "De opleiding", enquete_partie_moniteurs: "De instructeurs",
    enquete_aucun_moniteur: "Geen instructeur geregistreerd in dit dagboek.",
    commentaire_facultatif_placeholder: "Opmerking (optioneel)...",
    commentaire_placeholder: "Uw antwoord...",
    enquete_notes_manquantes: "Er ontbreekt nog een score om de enquête te kunnen indienen.",
    enquete_soumettre_btn: "Enquête indienen", enquete_envoi_en_cours: "Bezig met verzenden...",
    enquetes_terminees_titre: "Voltooide enquête(s)", enquetes_en_attente_titre: "Enquête(s) in afwachting",
    aucune_enquete_titre: "Momenteel geen enquête.",
    enquete_de_prefix: "Tevredenheidsenquête van", enquete_completee_le: "Voltooid op",
    eleve_inconnu: "Onbekende leerling", erreur_inconnue: "Onbekende fout.",
    ...
    titre_admin_label: "Titel", titre_admin_standard: "Admin (standaard)",
    ...
    reseau_ajouter_station: "Station toevoegen", reseau_tracer_trait: "Lijn tekenen", reseau_numero_station_placeholder: "Stationnr.",
    reseau_nom_station_placeholder: "Naam van het station",
    ...
    legende_correction_aide: "De vergelijking gebeurt automatisch (strikte spelling) — gebruik ✓/✗ om indien nodig te corrigeren (vergeten accent, toch als juist beschouwd antwoord...). De punten passen zich automatisch aan.",
    ...
    question_verrouillee_titre: "Vraag wordt al bewerkt",
    question_verrouillee_msg: "{nom} is deze vraag al aan het bewerken. Probeer het over enkele minuten opnieuw.",
    quelquun_dautre: "iemand anders",
    ...
    voir_description_categorie: "Beschrijving bekijken/bewerken", description_categorie_placeholder: "Beschrijving (optioneel)...",
    description_categorie_titre: "Beschrijving — {cat}", aucune_description: "Geen beschrijving voor deze categorie.",
    ...
    mode_questions_ciblees: "Gerichte vra(a)g(en)", rechercher_question_placeholder: "Zoeken op nummer of tekst...",
    aucune_question_trouvee: "Geen enkele vraag komt overeen.", questions_selectionnees_n: "{n} vra(a)g(en) geselecteerd",
    ...
    point_word: "Punt", ajoutez_image_dabord: "Voeg eerst hierboven een afbeelding toe.", retirer_image_btn: "Afbeelding verwijderen",
