...
export function rowToQuestion(row) {
  return {
    ...
    points: row.points,
    pointsParBonneReponse: row.points_par_bonne_reponse ?? undefined, media: row.media || null, mediaNl: row.media_nl || null,
    ...
    ciblesNl: row.cibles_nl || undefined, marqueursNl: row.marqueurs_nl || undefined,
...
export function questionToRow(q) {
  return {
    ...
    points: q.points,
    points_par_bonne_reponse: q.pointsParBonneReponse ?? null, media: q.media || null, media_nl: q.mediaNl || null,
    ...
    cibles_nl: q.ciblesNl || null, marqueurs_nl: q.marqueursNl || null,
    items: q.items || null,
